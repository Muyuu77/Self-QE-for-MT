...
# BPE Model
bpe_model = youtokentome.BPE(model="/content/drive/MyDrive/Master_Project/Data/data/bpe.model")
# bpe_model = youtokentome.BPE(model="/Users/yuumu/Desktop/Master_Sem1/Master_project/Translation Model/data/bpe.model")

# Transformer model
checkpoint = torch.load("/content/drive/MyDrive/Master_Project/Data/data/transformer_checkpoint.pth.tar")
...
if __name__ == '__main__':
    student_output = []
    with open('/content/drive/MyDrive/Master_Project/Data/data/teacher_input.txt', 'r') as file:
        lines = file.readlines()
        for i in range(len(lines)):
            best,_ = translate(lines[i])
            student_output.append(best)
            if i == 10:
                break

    with open('/content/drive/MyDrive/Master_Project/Data/data/student_output.txt','w') as file:
